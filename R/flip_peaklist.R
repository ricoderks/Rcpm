#' @title Transpose a peaklist from XCMS
#'
#' @description This functions transposes a peaklist generated by XCMS.
#'
#' @param peaklist peaklist created by XCMS
#' @param xset xcmsSet object
#'
#' @return The transposed peaklist as dataframe.
#' 
#' @details This functions transposes a peaklist generated by XCMS so that samples (observations) are rows and variables (features) are columns.
#' 
#' @export
