...
#' @param MetaFile the meta file. This file should be comma seperated.
...
#'   Sample names should start with QCpool_ or Sample_. This is used within the function to find where the actual data starts.
#' @author Rico Derks
