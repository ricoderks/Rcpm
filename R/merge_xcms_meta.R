#' @title Merge a XCMS output file with meta data
#'
#' @description This functions combines meta data with a XCMS output file. The merge is done based on the sample name.
#'
...
#' 
#' @details This functions is based on our data analysis protocol. The XCMS peak picking is done on the QCpool and actual samples. 
#' Sample names should start with \code{QCpool_} or \code{Sample_}. This is used within the function to find where the actual data starts. 
#' The MetaFile should contain a column with the name \code{SampleName}. Merging of both files is based on the sample name.
#' 
#' @export
