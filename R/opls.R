#' @title Orthogonal Projections to Latent Structures (OPLS) for a single Y
#'
#' @description Orthogonal Projections to Latent Structures (OPLS) for a single Y. Written by E.Nevedomskaya 2007-2013. 
...
#' 
#' @details Orthogonal Projections to Latent Structures (OPLS) for a single Y. The number of components can be determined with the function ncomp_opls.
#' 
#' @export
